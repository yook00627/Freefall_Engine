...
TextRenderer::TextRenderer(GLuint width, GLuint height)
{
	...
	this->TextShader = LoadShader("src/window/shader/text.vs", "src/window/shader/text.frag", nullptr, "text");
...
GLvoid PrintText::glPrint(const char *fmt, ...)
{
	char text[256];
	va_list ap;
